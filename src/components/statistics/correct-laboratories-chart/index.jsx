...
import { useGetCorrectLaboratoriesStatisticsHook } from "../../../features/statistics/hooks";
...
function CorrectLaboratoriesChart() {
    console.log('RENDER GENERAL STATISTICS PAGE')

    const { correctLaboratoriesStatistics, isLoading } = useGetCorrectLaboratoriesStatisticsHook();

    const formattedStatistics = correctLaboratoriesStatistics.map(
        (object) => renameKeys(
            object,
...
export default CorrectLaboratoriesChart;