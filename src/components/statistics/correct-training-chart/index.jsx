...
import { useGetCorrectTrainingStatisticsHook } from "../../../features/statistics/hooks";
...
function CorrectTrainingChart() {
    console.log('RENDER GENERAL STATISTICS PAGE')

    const { correctTrainingStatistics, isLoading } = useGetCorrectTrainingStatisticsHook();

    const formattedStatistics = correctTrainingStatistics.map(
        (object) => renameKeys(
            object,
...
export default CorrectTrainingChart;