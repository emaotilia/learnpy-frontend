...
import { useGetIncorrectLaboratoriesStatisticsHook } from "../../../features/statistics/hooks";
...
function IncorrectLaboratoriesChart() {
    console.log('RENDER GENERAL STATISTICS PAGE')

    const { incorrectLaboratoriesStatistics, isLoading } = useGetIncorrectLaboratoriesStatisticsHook();

    console.log(incorrectLaboratoriesStatistics);

    const formattedStatistics = incorrectLaboratoriesStatistics.map(
        (object) => renameKeys(
            object,
...
export default IncorrectLaboratoriesChart;